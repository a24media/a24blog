...
if (defined('ABSPATH') && !class_exists('kt_Central_Palette')) {
    define('KT_CENTRAL_PALETTE', '1.13.9');
    ...
    class kt_Central_Palette {
        ...
        const TINYMCE_RESET = 'kt_color_grid_mce_reset';
...
.mce-colorbutton-grid tr:nth-child($rows) td {padding-bottom: 4px}
        ...
        protected function save_settings() {
            ...
            $booleans = array(
                ...
                'kt_mce_reset' => self::TINYMCE_RESET,
            );
        ...
        protected function get_map_size() {
            switch (get_option(self::TYPE, self::DEFAULT_TYPE)) {
                case 'palette':
                    ...
                    if (get_option(self::TINYMCE_RESET)) {
                        $count++;
                    }
...
<div id='setting-error-import' class='$type settings-error notice is-dismissible'>
  <p><strong>$feedback</strong></p>
        ...
        public function print_grid_metabox() {
            $_reset = get_option(self::TINYMCE_RESET);
  ...
  <label for='kt_luma'>$luma_label</label>$luma";
            ...
            $reset_label = esc_html__('Add Reset Color', 'kt-tinymce-color-grid');
...
<p class='palette-options'>
  ...
  <label for='$id'>$label</label>
            ...
            $reset_checked = $_reset ? " checked='checked'" : '';
            print "
<p class='palette-options'>
  <input type='checkbox' id='kt_mce_reset' name='kt_mce_reset' value='1'$reset_checked/>
  <label for='kt_mce_reset'>$reset_label</label>
</p>";
